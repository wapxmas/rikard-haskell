...
foreign import ccall unsafe "mysql.h mysql_real_connect"
        mysql_real_connect
...
foreign import ccall unsafe "mysql.h mysql_close" mysql_close
    :: Ptr MYSQL -> IO ()

foreign import ccall unsafe "mysql.h mysql_ping" mysql_ping
    :: Ptr MYSQL -> IO CInt

foreign import ccall safe mysql_thread_id
    :: Ptr MYSQL -> IO CULong

foreign import ccall unsafe "mysql.h mysql_autocommit" mysql_autocommit
    :: Ptr MYSQL -> MyBool -> IO MyBool

foreign import ccall unsafe "mysql.h mysql_change_user" mysql_change_user
    :: Ptr MYSQL
    -> CString                  -- ^ user
    -> CString                  -- ^ password
    -> CString                  -- ^ database
...
foreign import ccall unsafe "mysql.h mysql_select_db" mysql_select_db
    :: Ptr MYSQL
    -> CString
    -> IO CInt
...
foreign import ccall unsafe "mysql.h mysql_stat" mysql_stat
    :: Ptr MYSQL -> IO CString

foreign import ccall unsafe "mysql.h mysql_real_query" mysql_real_query
...
foreign import ccall unsafe "mysql.h mysql_store_result" mysql_store_result
    :: Ptr MYSQL -> IO (Ptr MYSQL_RES)

foreign import ccall unsafe "mysql.h mysql_use_result"  mysql_use_result
    :: Ptr MYSQL -> IO (Ptr MYSQL_RES)

foreign import ccall unsafe "mysql.h mysql_free_result" mysql_free_result
    :: Ptr MYSQL_RES -> IO ()
...
foreign import ccall unsafe "mysql.h mysql_next_result" mysql_next_result
    :: Ptr MYSQL -> IO CInt

foreign import ccall unsafe "mysql.h mysql_commit" mysql_commit
    :: Ptr MYSQL -> IO MyBool

foreign import ccall unsafe "mysql.h mysql_rollback" mysql_rollback
    :: Ptr MYSQL -> IO MyBool

foreign import ccall unsafe "mysql.h mysql_fetch_row" mysql_fetch_row
